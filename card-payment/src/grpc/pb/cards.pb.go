...
type AuhtorizePaymentRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	TrasanctionDate string  `protobuf:"bytes,4,opt,name=trasanctionDate,proto3" json:"trasanctionDate,omitempty"`
}

func (x *AuhtorizePaymentRequest) Reset() {
	*x = AuhtorizePaymentRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *AuhtorizePaymentRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AuhtorizePaymentRequest) ProtoMessage() {}

func (x *AuhtorizePaymentRequest) ProtoReflect() protoreflect.Message {
	mi := &file_cards_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AuhtorizePaymentRequest.ProtoReflect.Descriptor instead.
func (*AuhtorizePaymentRequest) Descriptor() ([]byte, []int) {
	return file_cards_proto_rawDescGZIP(), []int{4}
}

func (x *AuhtorizePaymentRequest) GetAmount() float64 {
	if x != nil {
		return x.Amount
	}
	return 0
...
func (x *AuhtorizePaymentRequest) GetCardToken() string {
	if x != nil {
		return x.CardToken
	}
	return ""
...
func (x *AuhtorizePaymentRequest) GetPaymentType() string {
	if x != nil {
...
func (x *AuhtorizePaymentRequest) GetTrasanctionDate() string {
	if x != nil {
		return x.TrasanctionDate
	}
	return ""
}
...
func (x *PaymentAuthorization) Reset() {
	*x = PaymentAuthorization{}
	if protoimpl.UnsafeEnabled {
...
func (x *PaymentAuthorization) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PaymentAuthorization) ProtoMessage() {}

func (x *PaymentAuthorization) ProtoReflect() protoreflect.Message {
	mi := &file_cards_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PaymentAuthorization.ProtoReflect.Descriptor instead.
func (*PaymentAuthorization) Descriptor() ([]byte, []int) {
	return file_cards_proto_rawDescGZIP(), []int{5}
}

func (x *PaymentAuthorization) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *PaymentAuthorization) GetAmount() float64 {
	if x != nil {
		return x.Amount
	}
	return 0
...
func (x *PaymentAuthorization) GetStatus() string {
	if x != nil {
		return x.Status
	}
	return ""
...
func (x *PaymentAuthorization) GetTransactionDate() string {
	if x != nil {
...
func (x *PaymentAuthorization) GetCreatedAt() string {
	if x != nil {
		return x.CreatedAt
	}
	return ""
...
var file_cards_proto_rawDesc = []byte{
	...
	0x52, 0x07, 0x69, 0x73, 0x44, 0x65, 0x62, 0x69, 0x74, 0x22, 0x9b, 0x01, 0x0a, 0x17, 0x41, 0x75,
	0x68, 0x74, 0x6f, 0x72, 0x69, 0x7a, 0x65, 0x50, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x52, 0x65,
	...
	0x09, 0x63, 0x61, 0x72, 0x64, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x09, 0x63, 0x61, 0x72, 0x64, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x20, 0x0a, 0x0b, 0x70,
	0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x54, 0x79, 0x70, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x0b, 0x70, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x54, 0x79, 0x70, 0x65, 0x12, 0x28, 0x0a,
	0x0f, 0x74, 0x72, 0x61, 0x73, 0x61, 0x6e, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x44, 0x61, 0x74, 0x65,
	0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0f, 0x74, 0x72, 0x61, 0x73, 0x61, 0x6e, 0x63, 0x74,
	0x69, 0x6f, 0x6e, 0x44, 0x61, 0x74, 0x65, 0x22, 0x9e, 0x01, 0x0a, 0x14, 0x50, 0x61, 0x79, 0x6d,
	...
	,
...
var file_cards_proto_goTypes = []interface{}{
	...
	(*AuhtorizePaymentRequest)(nil), // 4: cards.AuhtorizePaymentRequest
	(*PaymentAuthorization)(nil),    // 5: cards.PaymentAuthorization
}
var file_cards_proto_depIdxs = []int32{
	...
	4, // 2: cards.Cards.AuthorizePayment:input_type -> cards.AuhtorizePaymentRequest
	1, // 3: cards.Cards.GenerateCard:output_type -> cards.FullCard
	3, // 4: cards.Cards.GetCardByToken:output_type -> cards.Card
	5, // 5: cards.Cards.AuthorizePayment:output_type -> cards.PaymentAuthorization
...
func file_cards_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_cards_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AuhtorizePaymentRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_cards_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PaymentAuthorization); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
